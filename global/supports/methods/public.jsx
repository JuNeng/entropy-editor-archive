...
module.exports = {
  ...
  checkQiniu: {
    checkQiniuImgToken: function(key) {
      ...
      let last_qiniu_token_time = localStorage.getItem(
        "last_qiniu_token_time_" + key
      );
      let mark = false;
    ...
    returnToken: function(uploadConfig = {}, key = "image", params = {}) {
      ...
      token =
        !!token == true ? token : this.getQiniuToken(uploadConfig, key, params);
      return token;
    },
