...
Renderer.prototype.list = function(childNode, isOrdered) {
  return new _syntheticDom.ElementNode(
    isOrdered ? "ol" : "ul",
    [],
    [childNode]
  );
...
Renderer.prototype.codespan = function(text) {
  return new _syntheticDom.ElementNode(
    "code",
    [],
    [new _syntheticDom.TextNode(text)]
  );
};
...
var MarkdownParser = {
  parse: function parse(src, options) {
    ...
    try {
      ...
      if (options.silent) {
        fragment = new _syntheticDom.FragmentNode([
          new _syntheticDom.ElementNode(
            "p",
            [],
            [new _syntheticDom.TextNode("An error occured:")]
          ),
          new _syntheticDom.ElementNode(
            "pre",
            [],
            [new _syntheticDom.TextNode(e.message)]
          )
        ]);
      } else {
        throw e;
