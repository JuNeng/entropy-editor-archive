...
_defineProperty(_ENTITY_ATTR_MAP, _main.ENTITY_TYPE.LINK, {
  url: "href",
  rel: "rel",
  target: "target",
  title: "title",
...
_defineProperty(_ENTITY_ATTR_MAP, _main.ENTITY_TYPE.IMAGE, {
  src: "src",
  height: "height",
  width: "width",
  alt: "alt",
...
_defineProperty(_ENTITY_ATTR_MAP, _main.ENTITY_TYPE.VIDEO, {
  src: "src",
  controls: "controls",
  height: "height",
  width: "width",
...
_defineProperty(_ENTITY_ATTR_MAP, _main.ENTITY_TYPE.AUDIO, {
  src: "src",
  controls: "controls",
  height: "height",
  width: "width",
...
_defineProperty(_DATA_TO_ATTR, _main.ENTITY_TYPE.LINK, function(
  entityType,
  entity
) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType)
  ...
  try {
    for (
      var _iterator = Object.keys(data)[Symbol.iterator](), _step;
...
_defineProperty(_DATA_TO_ATTR, _main.ENTITY_TYPE.IMAGE, function(
  entityType,
  entity
) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType)
  ...
  try {
    for (
      var _iterator2 = Object.keys(data)[Symbol.iterator](), _step2;
...
_defineProperty(_DATA_TO_ATTR, _main.ENTITY_TYPE.VIDEO, function(
  entityType,
  entity
) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType)
  ...
  try {
    for (
      var _iterator3 = Object.keys(data)[Symbol.iterator](), _step3;
...
_defineProperty(_DATA_TO_ATTR, _main.ENTITY_TYPE.AUDIO, function(
  entityType,
  entity
) {
  var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType)
  ...
  try {
    for (
      var _iterator4 = Object.keys(data)[Symbol.iterator](), _step4;
  ...
  _createClass(MarkupGenerator, [
    ...
    },
    {
      ...
      value: function writeStartTag(blockType, blockData) {
        ...
        try {
          for (
            var _iterator5 = tags[Symbol.iterator](), _step5;
    ...
    },
    {
      ...
      value: function writeEndTag(blockType) {
        ...
        if (tags.length === 1) {
          ...
          try {
            for (
              var _iterator6 = tags[Symbol.iterator](), _step6;
        ...
        return entityPieces
          .map(function(_ref) {
              ...
              .map(function(_ref3) {
                ...
                Object.keys(_colorConfig.colorStyleMap).map(function(keyItem) {
                  if (!!keyItem && style.has(keyItem)) {
                    content =
                      '<span style="color:' +
                      _colorConfig.colorStyleMap[keyItem].color +
                      '">' +
                      content +
                      "</span>";
                  }
                ...
                if (style.has(CODE)) {
                  content =
                    blockType === _main.BLOCK_TYPE.CODE
                      ? content
                      : "<code>" + content + "</code>";
                }
                return content;
            ...
            if (entityType != null && entityType === _main.ENTITY_TYPE.LINK) {
              ...
              entityType != null &&
              entityType === _main.ENTITY_TYPE.IMAGE
            ) {
              ...
              entityType != null &&
              entityType === _main.ENTITY_TYPE.VIDEO
            ) {
              var _attrs2 = DATA_TO_ATTR.hasOwnProperty(entityType)
                ? DATA_TO_ATTR[entityType](entityType, entity)
                : null;
              ...
              entityType != null &&
              entityType === _main.ENTITY_TYPE.AUDIO
            ) {
              var _attrs3 = DATA_TO_ATTR.hasOwnProperty(entityType)
                ? DATA_TO_ATTR[entityType](entityType, entity)
                : null;
...
function stringifyAttrs(attrs) {
  ...
  try {
    for (
      var _iterator7 = Object.keys(attrs)[Symbol.iterator](), _step7;
