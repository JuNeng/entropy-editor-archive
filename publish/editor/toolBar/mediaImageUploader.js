...
var ImgStyleControls = (function(_Component) {
  ...
  function ImgStyleControls(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        ImgStyleControls.__proto__ || Object.getPrototypeOf(ImgStyleControls)
      ).call(this, props)
    );
    ...
    _this.prepareToSendImageToEditor = _this.prepareToSendImageToEditor.bind(
      _this
    );
  ...
  _createClass(ImgStyleControls, [
    ...
    },
    {
      ...
      value: function prepareToSendImageToEditor() {
        if (!!this.state.images.length) {
          this.state.loadingRemoteImageFun = _message2.default.loading(
    ...
    },
    {
      ...
      value: function successLoading(type) {
        ...
        var validPfopImages = (0, _cloneDeep2.default)(pfopImages, function(
          item
        ) {
          return !!item.url;
        });
    ...
    },
    {
      ...
      value: function reloadPfopingPictrue(picture, index) {
        var thePicture = picture.substr(
          0,
          ~picture.lastIndexOf("?t=")
            ? picture.lastIndexOf("?t=")
            : picture.length
        );
        var n = picture.substr(
          (~picture.lastIndexOf("?t=")
            ? picture.lastIndexOf("?t=")
            : picture.length) + 3
        );
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_icon2.default, {
              type: "editor_image",
              title: this.props.lang.originalImage
            })
          ),
          _react2.default.createElement(
            "div",
