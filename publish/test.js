...
var _index = require("./editor/index");
...
var Test = (function(_React$Component) {
  ...
  function Test(props) {
    ...
    var _this2 = _possibleConstructorReturn(
      this,
      (Test.__proto__ || Object.getPrototypeOf(Test)).call(this, props)
    );
    ...
    _this2.state = {
      ...
      rawContent:
        '{"entityMap":{"0":{"type":"image","mutability":"IMMUTABLE","data":{"src":"https://image.qiluyidian.mobi/4305350813991067' +
  ...
  _createClass(Test, [
    ...
    },
    {
      ...
      value: function getSignature(fileName) {
        var now = new Date();
        var h = (0, _hmacsha2.default)(
          "19931944122b23f77681b6ab765648f8",
          "POST&/upyun-temp/" + fileName + "&" + now
        );
    ...
    },
    {
      ...
      value: function getPolicy(fileName) {
        ...
        var policy = _jsBase.Base64.encode(
          JSON.stringify({
            bucket: "devopee",
            "save-key": "/" + fileName,
      ...
      value: function render() {
        ...
        var uploadProps = {
          ...
          data: function data(file) {
            return {
              Authorization:
                "UPYUN reactlzeditor:" + _this3.getSignature(file.name),
              policy: (function() {
                policy = _this3.getPolicy(file.name);
                return policy;
              })(),
              signature: (0, _md2.default)(
                policy + "&pLv/J4I6vfpeznxtwU+g/dsUcEY="
              )
            };
          },
          multiple: true,
