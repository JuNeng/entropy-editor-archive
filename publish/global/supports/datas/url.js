...
module.exports = {
  ...
  activity_public: {
    ...
    get_checking_channels_cities: {
      url:
        _base2.default.Config.server.ajax + "get_checking_channels_cities.do",
      authId: "",
      method: "post",
      defaultData: {}
    },
    set_checking_channels_cities: {
      url:
        _base2.default.Config.server.ajax + "set_checking_channels_cities.do",
      authId: "",
      method: "post",
      defaultData: {}
    },
  ...
  newsradar: {
    rank: {
      ...
      clearorders: {
        url:
          _base2.default.Config.server.ajax +
          "updateIntelligenceInfoTopnumdefault.do"
      }
    },
    list: {
    ...
    batch_deletes: {
      url:
        _base2.default.Config.server.ajax + "batchUpdateIntelligenceStatus.do"
    },
    item_pass: {
    ...
    batch_pass: {
      url:
        _base2.default.Config.server.ajax +
        "batchUpdateIntelligenceUseStatus.do"
    },
    view_item: {
    ...
    amount: {
      url:
        _base2.default.Config.server.ajax +
        "selectIntelligenceCountByUseStatus.do"
    },
    ...
    report_list_byid: {
      url:
        _base2.default.Config.server.ajax +
        "queryIntelligenceReplyByIntelligenceId.do"
    },
    report_batch_pass: {
      url:
        _base2.default.Config.server.ajax + "batchUpdateIntelReplyUseStatus.do"
    },
    ...
    report_item_pass: {
      url:
        _base2.default.Config.server.ajax +
        "updateIntelligenceReplyUseStatus.do"
    },
    report_item_deletes: {
  ...
  biguser: {
    list: {
      list: {
        url:
          _base2.default.Config.server.ajax +
          "queryAllChannelGeneralInfoList.do"
      },
      update_status: {
      ...
      item: {
        url:
          _base2.default.Config.server.ajax + "preUpdateChannelGeneralInfo.do"
      },
      add: {
        url: _base2.default.Config.server.ajax + "addChannelGeneralInfo.do"
      },
      reset: { url: _base2.default.Config.server.ajax + "resetUserPwd.do" },
      update: {
        url: _base2.default.Config.server.ajax + "updateChannelGeneralInfo.do"
      },
      hot_order: {
        url: _base2.default.Config.server.ajax + "getSubChannelHotList4Range.do"
      },
      change_hot_order: {
        url: _base2.default.Config.server.ajax + "getRankIntelligenceList.do"
      },
      fresh_order: {
        url:
          _base2.default.Config.server.ajax + "getSubChannelFreshList4Range.do"
      },
      set_fresh_order: {
        url: _base2.default.Config.server.ajax + "setFreshnumOrders.do"
      }
    },
    list_verifier: {
      list: {
        url:
          _base2.default.Config.server.ajax +
          "selectChannelExamineListByParam.do"
      },
      change: {
        url: _base2.default.Config.server.ajax + "updateChannelExamineInfo.do"
      }
    },
    type: {
      list: {
        url:
          _base2.default.Config.server.ajax + "selectChannelTypePageByParam.do"
      },
      add: { url: _base2.default.Config.server.ajax + "insertChannelType.do" },
      update: {
        url: _base2.default.Config.server.ajax + "updateChannelType.do"
      },
      deletes: {
        url: _base2.default.Config.server.ajax + "deleteChannelType.do"
      },
      reset: {
        url: _base2.default.Config.server.ajax + "removeChannelType.do"
      },
      orders: {
        url:
          _base2.default.Config.server.ajax + "updateChannelTypeOrderNumById.do"
      },
      all: {
        url: _base2.default.Config.server.ajax + "selectChannelTypeList.do"
      }
    },
    news: {
      list: {
        url: _base2.default.Config.server.ajax + "queryAllSubChannelNewsList.do"
      },
      item: {
        url: _base2.default.Config.server.ajax + "getNewsInfoById4SubChannel.do"
      },
      update: {
        url: _base2.default.Config.server.ajax + "modifyNewsInfo4SubChannel.do"
      },
      chouqu: {
        url:
          _base2.default.Config.server.ajax +
          "drawSubChannelNews2OtherChannel.do"
      },
      deletes: {
        url: _base2.default.Config.server.ajax + "delNewsInfo4SubChannel.do"
      }
    },
    news_verifier: {
      list: {
        url:
          _base2.default.Config.server.ajax +
          "getAllSubChannelNewsList4Audit.do"
      },
      batch_pass: {
        url:
          _base2.default.Config.server.ajax + "batchAuditNewsInfo4SubChannel.do"
      }
    },
    grab: {
      list: {
        url: _base2.default.Config.server.ajax + "getAllSpideNewsList.do"
      },
      update: {
        url: _base2.default.Config.server.ajax + "modifySpiderNewsInfo.do"
      },
      batch_pass: {
        url:
          _base2.default.Config.server.ajax + "batchDealSpiderSubChannelNews.do"
      }
    },
    comments: {
      list: {
        url:
          _base2.default.Config.server.ajax +
          "getAllSubChannelNewsCommentList.do"
      }
    }
  },
  activity: {
  ...
  public: {
    ...
    hot_words: {
      list: {
        url:
          _base2.default.Config.server.ajax + "selectHotwordInfoPageByParam.do"
      },
      add: {
    ...
    info: {
      list: {
        url:
          _base2.default.Config.server.ajax +
          "selectInternalMessageInfoPageByParam.do"
      },
      add: {
    ...
    appuser: {
      ...
      getUserScoreLog: {
        url:
          _base2.default.Config.server.ajax + "queryClientUserScoreHisList.do"
      },
      getUserInvitationLog: {
        url:
          _base2.default.Config.server.ajax + "queryClientUserInviteUserList.do"
      },
      downloadUserList: {
      ...
      downloadUserInvitationList: {
        url:
          _base2.default.Config.server.ajax +
          "downloadClientUserInviteListFile.do"
      }
    },
    softupdate: {
      list: {
        url:
          _base2.default.Config.server.ajax +
          "selectAppUpdateInfoPageByParam.do"
      },
      add: {
  ...
  circles: {
    circle: {
      ...
      get_discoveries: {
        authId: "2111",
        url:
          _base2.default.Config.server.ajax + "circle_get_discoveries_list.do",
        method: "post",
        isAsync: true,
        defaultData: {}
      },
      clear_discoveries: {
        ...
        url:
          _base2.default.Config.server.ajax +
          "circle_empty_discoveries_list.do",
        method: "post",
        isAsync: true,
        defaultData: {}
      }
    ...
    panorama: {
      tongji: {
        news_tongji: {
          list: {
            url:
              _base2.default.Config.server.ajax + "selectChannelListByParam.do"
          },
          out_excel: {
  ...
  channel: {
    ...
    orders: {
      url:
        _base2.default.Config.server.ajax + "updateChannelBaseInfoRecommend.do"
    },
    all: {
  ...
  appClient: {
    startPage: {
      ...
      getItemRefReport: {
        url:
          _base2.default.Config.server.ajax + "getIntelligenceList4Openimg.do"
      }
    }
  }
};
