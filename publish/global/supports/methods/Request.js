  ...
  ajax: {
    ...
    getParams: function getParams(data) {
      ...
      for (var i in data) {
        ...
        if (
          (typeof temp === "undefined" ? "undefined" : _typeof(temp)) ==
          "object"
        ) {
    ...
    requestData: function requestData(urlObj) {
      ...
      data = Object.assign(
        {},
        urlObj.defaultData ? urlObj.defaultData : "",
        {
          tokenID: "yourTokenID"
        },
        data
          ...
          if (!!onSuccess) {
            ...
            try {
              ...
              _message2.default.error(
                "数据返回出错，请通知技术部排查，参考原因：“" +
                  e.toString() +
                  "”；返回数据：“" +
                  (xhr.responseText.length > 20
    ...
    fetchData: function fetchData(urlObj) {
      ...
      data = Object.assign(
        {},
        urlObj.hasOwnProperty("defaultData") ? urlObj.defaultData : {},
        {
          tokenID: tokenID
        },
        data
