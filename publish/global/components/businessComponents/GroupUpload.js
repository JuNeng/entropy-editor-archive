...
var GroupUpload = (function(_Component) {
  ...
  function GroupUpload(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (GroupUpload.__proto__ || Object.getPrototypeOf(GroupUpload)).call(
        this,
        props
      )
    );
  ...
  _createClass(GroupUpload, [
    ...
    },
    {
      ...
      value: function onSelectAPicture(e, item) {
        ...
        this.state.selectedPictureList = (0, _uniq2.default)(
          this.state.selectedPictureList
        );
        this.forceUpdate();
      }
    },
    {
      ...
      value: function handlePictureSeletorOK() {
        ...
        if (this.state.isAutoWaterMark == true) {
          ...
          setTimeout(function() {
            _this2.props.receiveSelectedPictures(
              _this2.state.selectedPictureList
            );
          }, 400);
        }
      }
      ...
      value: function getPfop() {
        ...
        var newPicturesObj = this.state.selectedPictureList.map(function(item) {
          if (!!item && !~item.lastIndexOf("reset")) {
            ...
            if (_this3.state.isAutoSize) {
              if (
                _this3.props.atuoSize[0] == 0 &&
                _this3.props.atuoSize[1] == 0
              ) {
                thumbnail = "imageMogr2/thumbnail/600x600>|";
              } else if (_this3.props.atuoSize[0] == 0) {
                thumbnail =
                  "imageMogr2/thumbnail/x" + _this3.props.atuoSize[1] + ">|";
              } else if (_this3.props.atuoSize[1] == 0) {
                thumbnail =
                  "imageMogr2/thumbnail/" + _this3.props.atuoSize[0] + "x>|";
              } else {
                thumbnail =
                  "imageMogr2/thumbnail/" +
                  _this3.props.atuoSize[0] +
                  "x" +
                  _this3.props.atuoSize[1] +
                  ">|";
              }
            }
            return {
              originPic:
                ...
                thumbnail +
                "watermark/1/gravity/" +
                _this3.state.selectedWaterMarkPositon +
                "/image/" +
                (0, _find2.default)(
                  _publicDatas.PRO_BASE.Config.watermarkImage,
                  function(item) {
        ...
        var pictureList = refObj.map(function(item) {
          var domain = "",
            picture = "";
          if (!!item.originPic) {
            domain = item.originPic.substr(
              0,
              item.originPic.lastIndexOf(item.key)
            );
    ...
    },
    {
      ...
      value: function getPfopPictures(pictures) {
        ...
        _publicDatas.PRO_REQUEST.ajax.fetchData(
          this.props.uploadConfig.QINIU_PFOP,
          {
            list: pictures
          },
          function(data) {
    ...
    },
    {
      ...
      value: function getPictures(listPicture) {
        ...
        this.state.pictureList = (0, _compact2.default)(
          this.state.pictureList.concat(newPictures)
        );
        this.state.pictureList = (0, _uniq2.default)(this.state.pictureList);
        this.state.selectedPictureList = (0, _cloneDeep2.default)(
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(prevProps, nextProps) {
        if (!!nextProps && nextProps.hasOwnProperty("imageList")) {
          this.setState({
            pictureList: nextProps.imageList,
            selectedPictureList: (0, _cloneDeep2.default)(nextProps.imageList)
          });
        } else {
    ...
    },
    {
      ...
      value: function componentDidMount() {
        if (
          (this.props.atuoSize[0] <= 300 && this.props.atuoSize[0] != 0) ||
          (this.props.atuoSize[1] <= 64 && this.props.atuoSize[1] != 0)
        ) {
          ...
          _react2.default.createElement(
            _modal2.default,
            {
              title: _react2.default.createElement(
                ...
                _react2.default.createElement(
                  _select2.default,
                  {
                    size: "small",
                    disabled:
                      !this.state.isAutoWaterMark ||
                      !watermarkImage ||
                      watermarkImage.length == 0,
                    defaultValue: this.state.selectedWaterMarkType,
                    style: { width: 100 },
                    onChange: this.chooseWaterMake
                  },
                  watermarkImage &&
                    watermarkImage.map(function(item) {
                      return _react2.default.createElement(
                ...
                atuoSize
                  ? _react2.default.createElement(
                      _checkbox2.default,
                      {
                        ...
                        defaultChecked: this.state.isAutoSize
                      },
                      lang.zoomTipMsg
                        .replace(
                          "$accordingSize$",
                          atuoSize[0] == 0 ? lang.height : lang.width
                        )
                        .replace(
                          "$targetSize$",
                          (atuoSize[0] || lang.auto) +
                            "*" +
                            (atuoSize[1] || lang.auto)
                        )
                    )
                  : null
              ),
              ...
              footer: [
                _react2.default.createElement(
                  _button2.default,
                  { key: "back", size: "large", onClick: this.closeModal },
                  " ",
                  lang.cancelText,
                  " "
                ),
