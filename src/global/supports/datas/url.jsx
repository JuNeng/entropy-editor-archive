...
module.exports = {
  ...
  newsradar: {
    rank: {
      ...
      clearorders: {
        url:
          PRO_BASE.Config.server.ajax + "updateIntelligenceInfoTopnumdefault.do"
      }
    },
    list: {
    ...
    report_list_byid: {
      //某条情报的评论列表
      url:
        PRO_BASE.Config.server.ajax +
        "queryIntelligenceReplyByIntelligenceId.do"
    },
    report_batch_pass: {
      //情报站回复评论的批量审核通过 or 不过
  ...
  biguser: {
    ...
    list: {
      //壹点号
      list: {
        url: PRO_BASE.Config.server.ajax + "queryAllChannelGeneralInfoList.do"
      },
      update_status: {
        url: PRO_BASE.Config.server.ajax + "updateChannelInfoStatus.do"
      },
      item: {
        url: PRO_BASE.Config.server.ajax + "preUpdateChannelGeneralInfo.do"
      },
      ...
      update: {
        url: PRO_BASE.Config.server.ajax + "updateChannelGeneralInfo.do"
      },
      hot_order: {
        url: PRO_BASE.Config.server.ajax + "getSubChannelHotList4Range.do"
      },
      change_hot_order: {
        url: PRO_BASE.Config.server.ajax + "getRankIntelligenceList.do"
      },
      fresh_order: {
        url: PRO_BASE.Config.server.ajax + "getSubChannelFreshList4Range.do"
      },
      set_fresh_order: {
        url: PRO_BASE.Config.server.ajax + "setFreshnumOrders.do"
      }
    },
    list_verifier: {
      //待审核的壹点号接口，类主任审核
      list: {
        url: PRO_BASE.Config.server.ajax + "selectChannelExamineListByParam.do"
      },
      change: {
        url: PRO_BASE.Config.server.ajax + "updateChannelExamineInfo.do"
      }
    },
    type: {
      //壹点号的类型
      list: {
        url: PRO_BASE.Config.server.ajax + "selectChannelTypePageByParam.do"
      },
      ...
      orders: {
        url: PRO_BASE.Config.server.ajax + "updateChannelTypeOrderNumById.do"
      },
    ...
    news: {
      //壹点号新闻
      list: {
        url: PRO_BASE.Config.server.ajax + "queryAllSubChannelNewsList.do"
      },
      item: {
        url: PRO_BASE.Config.server.ajax + "getNewsInfoById4SubChannel.do"
      },
      update: {
        url: PRO_BASE.Config.server.ajax + "modifyNewsInfo4SubChannel.do"
      },
      chouqu: {
        url: PRO_BASE.Config.server.ajax + "drawSubChannelNews2OtherChannel.do"
      },
      deletes: {
        url: PRO_BASE.Config.server.ajax + "delNewsInfo4SubChannel.do"
      }
    },
    news_verifier: {
      //壹点号的主任审核
      list: {
        url: PRO_BASE.Config.server.ajax + "getAllSubChannelNewsList4Audit.do"
      },
      batch_pass: {
        url: PRO_BASE.Config.server.ajax + "batchAuditNewsInfo4SubChannel.do"
      }
    },
    grab: {
      //壹点号的抓取
      ...
      batch_pass: {
        url: PRO_BASE.Config.server.ajax + "batchDealSpiderSubChannelNews.do"
      }
    },
    comments: {
      //壹点号的评论相关
      list: {
        url: PRO_BASE.Config.server.ajax + "getAllSubChannelNewsCommentList.do"
      }
    }
  },
  activity: {
